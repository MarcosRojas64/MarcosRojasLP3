<?php
 ...
 <td><?=$row['apellido']?></td>
 <td>
 <a class="btn btn-info" data-bs-toggle="modal" data-bstarget="#idver<?=$row['idEstudiante']?>">Ver</a>
 <a href="edit.php?id=<?=$row['idEstudiante']?>" class="btn btnwarning">Editar</a>
 <a class="btn btn-danger" data-bs-toggle="modal" data-bstarget="#iddel<?=$row['idEstudiante']?>">Eliminar</a>
