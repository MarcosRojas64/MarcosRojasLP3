...
class matriculaController {
 ...
 return ($id!=false) ? header('location: ./index.php') : header('location:
./create.php');
 }

 public function update($id,$fecha,$idEstudiante,$idUsuario,$idCurso){
 return ($this->model->actualizar($id,$fecha,$idEstudiante,$idUsuario,$idCurso) !=
false) ? header('location: ./index.php') : header('location: ./edit.php?id='.$id);
 }
