...
nombre=:nombre,apellido=:apellido,idCiudad=:idCiudad,cin=:cin WHERE
idEstudiante=:idEstudiante';
 ...
 $sql = 'SELECT e.idEstudiante,e.nombre,e.apellido,e.idCiudad,e.cin,c.nombre
ciudad FROM estudiantes e JOIN ciudades c ON e.idCiudad = c.idCiudad ORDER BY idEstudiante
DESC';
 $statement = $this->PDO->prepare($sql);
 ...
 return ($statement->execute()) ? $statement->fetchAll() : false;
  ...
  $sql = 'SELECT e.idEstudiante,e.nombre,e.apellido,e.idCiudad,e.cin,c.nombre
 ciudad FROM estudiantes e JOIN ciudades c ON e.idCiudad = c.idCiudad WHERE idEstudiante =
 :idEstudiante';
  $statement = $this->PDO->prepare($sql);
  $statement->bindParam(':idEstudiante',$idEstudiante);
