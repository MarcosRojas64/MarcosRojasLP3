...
include '../library/configServer.php';
 ...
 echo '<img src="assets/img/ok.png" class="center-all-contens"><br><p class="lead textcenter">Pedido eliminado éxitosamente</p>';
 ...
 echo '<img src="assets/img/error.png" class="center-all-contens"><br><p class="lead textcenter">El pedido no existe</p>';
