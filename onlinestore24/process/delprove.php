 ...
 echo '<img src="assets/img/ok.png" class="center-all-contens"><br><p class="lead textcenter">Proveedor eliminado éxitosamente</p>';
 ...
 echo '<img src="assets/img/error.png" class="center-all-contens"><br><p class="lead textcenter">El código de proveedor no existe</p>';
