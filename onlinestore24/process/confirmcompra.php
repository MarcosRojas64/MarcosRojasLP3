<?php
 ...
 $verdata= ejecutarSQL::consultar("select * from cliente where Clave='".$passClien."' and
Nombre='".$nameClien."'");
 ...
 consultasSQL::InsertSQL("venta", "Fecha, RUC, Descuento, TotalPagar, Estado", "'".date('d-mY')."','".$RUCC."','0','".$_SESSION['sumaTotal']."','".$StatusV."'");

 /*recuperando el número del pedido actual*/
 $verId=ejecutarSQL::consultar("select * from venta where RUC='$RUCC' order by NumPedido desc
limit 1");
...
"'$Numpedido', '".$_SESSION['producto'][$i]."', '1'");
 ...
 $prodStock=ejecutarSQL::consultar("select * from producto where
...
"CodigoProd='".$_SESSION['producto'][$i]."'");
 ...
 echo '<img src="assets/img/ok.png" class="center-all-contens"><br>El pedido se ha realizado
con éxito';
 }else{
echo '<img src="assets/img/error.png" class="center-all-contens"><br>No has seleccionado
ningún producto, revisa el carrito de compras';
 }
}else{
     echo '<img src="assets/img/error.png" class="center-all-contens"><br>El nombre o contraseña
    invalidos';
     }
