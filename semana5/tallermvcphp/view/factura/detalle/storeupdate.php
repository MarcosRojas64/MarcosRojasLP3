...
('idTmpDetalle'=>$ultimoID,'idConcepto'=>$idConcepto,'concepto'=>$concepto,
'cantidad'=>$cantidad, 'unitario'=>$unitario,'sesion'=>$sesion);
 ...
 $total_detalle=$total_detalle+$precio_total;
