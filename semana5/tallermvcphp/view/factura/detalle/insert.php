<?php
 ...
 return
json_decode(file_get_contents(VIEW_PATH."factura/detalle/tmpdetallefacturas$sesion.json"),
true);
 }
 ...
 file_put_contents(VIEW_PATH."factura/detalle/tmpdetallefacturas$sesion.json",
